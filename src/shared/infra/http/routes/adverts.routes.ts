...
AdvertsRoutes.get("/listByCategorie", authMiddleware, listAdsByCategoriesController.handle);//listar anuncios por categoria
AdvertsRoutes.get("/listByUser", authMiddleware, listAdsByUserController.handle);//listar anuncios por usuario
