...
export class Anuncios1620276830651 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKeys("anuncios",
        [
            new TableForeignKey(
                {
                    name: "FKAnunciosUser",
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.dropForeignKey( "anuncios", "FKAnunciosCategorie")
        await queryRunner.dropForeignKey("anuncios", "FKAnunciosUser")
